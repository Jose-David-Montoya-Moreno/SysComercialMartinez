    ...
    public class ProveedorDAL
    {
        ...
        public static async Task<int> ModificarAsync(Proveedor pProveedor)
        {
            ...
            using (var bdContexto = new BDContexto())
            {
                ...
                proveedor.NumeroCuenta = pProveedor.NumeroCuenta;
        ...
        internal static IQueryable<Proveedor> QuerySelect(IQueryable<Proveedor> pQuery, Proveedor pProveedor)
        {
            ...
            if (!string.IsNullOrWhiteSpace(pProveedor.NumeroCuenta))
                pQuery = pQuery.Where(s => s.NumeroCuenta.Contains(pProveedor.NumeroCuenta));
